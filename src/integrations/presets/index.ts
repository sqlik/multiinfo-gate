...
export const PRESETS: Preset[] = [prostyJson, uptimeKuma, grafana, zabbix, woocommerce, woocommerceKlient, homeAssistant, freescoutZgloszenie, freescout, freshdeskZgloszenie, freshdesk, ntfy, custom];
