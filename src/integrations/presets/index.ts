...
/** Kolejność z tabeli specu; „Własne” zawsze na końcu kafelków. Slack i Teams czekają na potwierdzenie próbką (pliki obok). */
export const PRESETS: Preset[] = [prostyJson, n8n, uptimeKuma, grafana, zabbix, woocommerce, woocommerceKlient, homeAssistant, freescoutZgloszenie, freescout, freshdeskZgloszenie, freshdesk, ntfy, custom];
